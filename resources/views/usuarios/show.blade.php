...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary text-white text-center">{{ __('CADASTRAR USUÁRIO') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('usuarios.update', $usuario->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="surname" type="text" class="form-control" name="surname" value="{{ $usuario->surname }}" autocomplete="surname" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="text" class="form-control" name="username" value="{{ $usuario->username }}" autocomplete="username" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="group" class="form-control" name="group">
                                    ...
                                    {{ ($usuario->group == 'usuario' ? 'selected' : '') }}>
                                        Usuário
                                    </option>
                                    <option value="colaborador"
                                    {{ ($usuario->group == 'colaborador' ? 'selected' : '') }}>
                                        Colaborador
                                    </option>
                                    <option value="secretaria"
                                    {{ ($usuario->group == 'secretaria' ? 'selected' : '') }}>
                                        Secretaria
                                    </option>
                                    <option value="admin"
                                    {{ ($usuario->group == 'admin' ? 'selected' : '') }}>
                                        Admin
                                    </option>
                                </select>
                            </div>
